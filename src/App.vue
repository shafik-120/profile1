    ...
    <div class="col-span-12 lg:col-span-4 lg:h-screen lg:sticky top-44">
      <div class="w-full mb-6 lg:mb-0 mx-auto relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        ...
        <div class="pt-[100px] pb-8">
          ...
          <div class="flex justify-center space-x-3">
            ...
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
              <span class="socialbtn text-[#1C9CEA]">
                <svg fill=currentColor height=1em stroke=currentColor stroke-width=0 viewBox="0 0 512 512" width=1em
          ...
          <div class="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              <span class="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#E93B81] shadow-md">
                <svg fill=currentColor height=1em stroke=currentColor stroke-width=0 viewBox="0 0 320 512" width=1em
                  xmlns=http://www.w3.org/2000/svg>
                  <path
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">
                  <a class="hover:text-[#FA5252] duration-300 transition" href="tel:+1234567890">+123 456 7890</a>
                </p>
              </div>
            </div>
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              <span class="flex-shrink-0 socialbtn bg-white dark:bg-black text-[#6AB5B9]  shadow-md">
                <svg fill=currentColor height=1em stroke=currentColor stroke-width=0 viewBox="0 0 384 512" width=1em
                  xmlns=http://www.w3.org/2000/svg>
                  <path
            ...
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">
                  <a class="hover:text-[#FA5252] duration-300 transition"
                    href="mailto:ibthemes21@gmail.com">example@mail.com</a>
                </p>
              </div>
            </div>
          ...
          <a href="#" download=""
            class="inline-flex items-center mx-auto bg-gradient-to-r from-[#FA5252] to-[#DD2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476] to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
            <img src="https://bostami-nextjs.netlify.app/images/download.png" alt="icon" class="mr-2">Download CV</a>
        </div>
      </div>
    </div>
    <div class="col-span-12 lg:col-span-8 ">
      <header
        class="lg:w-[526px] h-[144px] hidden lg:block p-[30px] ml-auto mb-10 rounded-[16px] bg-white dark:bg-[#111111] ">
        <nav class="hidden lg:block">
          <ul class="flex ">
            <a href="/home-box-layout/home"
              ...
              <span class="text-xl mb-1">
                <svg fill=currentColor height=1em stroke=currentColor stroke-width=0 viewBox="0 0 1024 1024" width=1em
                  xmlns=http://www.w3.org/2000/svg>
                  <path
          ...
          <a href="/home-box-layout/resume"
            class="w-full h-20 rounded-[10px]  cursor-pointer  font-poppins  bg-[#F3F6F6]  font-medium mx-2.5  text-xtiny text-gray-lite dark:text-[#A6A6A6]    justify-center flex flex-col items-center   transition-all duration-300 ease-in-out dark:hover:text-white dark:bg-[#212425] hover:text-white   hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] ">
            <span class="text-xl mb-1">
              <svg fill=none height=1em stroke=currentColor stroke-width=0 viewBox="0 0 24 24" width=1em
                xmlns=http://www.w3.org/2000/svg>
                <path
          ...
          <a href="/home-box-layout/works"
            class="w-full h-20 rounded-[10px]  cursor-pointer  font-poppins  bg-[#F3F6F6]  font-medium mx-2.5  text-xtiny text-gray-lite dark:text-[#A6A6A6]    justify-center flex flex-col items-center   transition-all duration-300 ease-in-out dark:hover:text-white dark:bg-[#212425] hover:text-white   hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] ">
            <span class="text-xl mb-1">
              <svg fill=none height=1em stroke=currentColor stroke-linecap=round stroke-linejoin=round stroke-width=2
          ...
          <a href="/home-box-layout/contact"
            class="w-full h-20 rounded-[10px]  cursor-pointer  font-poppins  bg-[#F3F6F6]  font-medium mx-2.5  text-xtiny text-gray-lite dark:text-[#A6A6A6]    justify-center flex flex-col items-center   transition-all duration-300 ease-in-out dark:hover:text-white dark:bg-[#212425] hover:text-white   hover:bg-gradient-to-r from-[#FA5252] to-[#DD2476] ">
            <span class="text-xl mb-1">
              <svg fill=currentColor height=1em stroke=currentColor stroke-width=0 viewBox="0 0 24 24" width=1em
                xmlns=http://www.w3.org/2000/svg>
                <g>
