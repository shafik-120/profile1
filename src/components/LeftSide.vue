...
<template>
<div class="col-span-12 lg:col-span-4 lg:minh-screen lg:sticky top-44 ">
          ...
          <div class="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">
                  <a class="hover:text-[#FA5252] duration-300 transition" href="tel:+1234567890">+88 0175 6867 220</a>
                </p>
              </div>
            </div>
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">Rajshahi, Dhaka, Bangladesh</p>
              </div>
            </div>
            <div class="flex py-2.5 border-b border-[#E3E3E3] dark:border-[#3D3A3A]">
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">
                  <a class="hover:text-[#FA5252] duration-300 transition"
                    href="mailto:shafikul.18288@gmail.com">shafikul.18288@gmail.com</a>
                </p>
              </div>
            </div>
            <div class="flex py-2.5 undefined">
              ...
              <div class="text-left ml-2.5">
                ...
                <p class="dark:text-white break-all">Jun 05, 2001</p>
              </div>
            </div>
          </div>
          <a href="#" download=""
